                ...
                <div class="p-8 space-y-10 flex-grow">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-blue-600 shrink-0 w-7">2.6</span> <span class="leading-snug">Staffing Model, Skill Mix, On-call Coverage (linked to IPP-OT-021)</span></li>
            ...
            <div class="policy-card bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden flex flex-col h-full">
                ...
                <div class="p-8 space-y-10 flex-grow">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            <li class="flex items-start gap-3"><span class="font-bold text-teal-600 shrink-0 w-7">5.1</span> <span class="leading-snug">Surgical Booking Process &amp; Required Documentation (IPP-OT-001)</span></li>
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-teal-600 shrink-0 w-7">5.3</span> <span class="leading-snug">Day-of-Surgery Cancellation Criteria &amp; Escalation (IPP-OT-024)</span></li>
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-teal-600 shrink-0 w-7">5.8</span> <span class="leading-snug">Patient Acceptance Criteria for OT (IPP-OT-002)</span></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-teal-600 shrink-0 w-7">7.2</span> <span class="leading-snug">Safe Transfer of Patient (trolley ↔ OT table, safe handling) (IPP-OT-016)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-teal-600 shrink-0 w-7">7.3</span> <span class="leading-snug">OT On-Call System (activation, response time, responsibilities) (IPP-OT-021)</span></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            <li class="flex items-start gap-3"><span class="font-bold text-teal-600 shrink-0 w-7">8.1</span> <span class="leading-snug">Recovery Room Readiness + OT→PACU Handover (documentation + responsibility) (IPP-OT-017)</span></li>
                        </ul>
                    </div>
                ...
                <div class="p-8 space-y-8 flex-grow">
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.2</span> <span class="leading-snug">OT attire &amp; dress code (IPP-OT-003)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.3</span> <span class="leading-snug">Traffic control / door opening discipline (IPP-OT-004)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.4</span> <span class="leading-snug">Hand hygiene + surgical hand scrub (IPP-OT-005)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.5</span> <span class="leading-snug">Sterile gowning (IPP-OT-006)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.6</span> <span class="leading-snug">Sterile gloving (IPP-OT-007)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.7</span> <span class="leading-snug">Surgical skin antisepsis (IPP-OT-010)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.8</span> <span class="leading-snug">Draping (IPP-OT-011)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-rose-600 shrink-0 w-8">9.9</span> <span class="leading-snug">Maintaining sterile field &amp; contamination response (IPP-OT-013)</span></li>
                ...
                <div class="p-8 space-y-8 flex-grow">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-purple-600 shrink-0 w-10">11.2</span> <span class="leading-snug">Safe Practices in OT / Environmental Hazards / Wrong-Site Prevention (IPP-OT-012)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-purple-600 shrink-0 w-10">11.3</span> <span class="leading-snug">Surgical Counts (sponges/sharps/instruments) (IPP-OT-008)</span></li>
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-purple-600 shrink-0 w-10">11.5</span> <span class="leading-snug">Patient Positioning &amp; Pressure Injury Prevention (IPP-OT-009)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-purple-600 shrink-0 w-10">11.6</span> <span class="leading-snug">Specimen Handling, Labeling &amp; Transport (IPP-OT-014)</span></li>
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-purple-600 shrink-0 w-10">11.12</span> <span class="leading-snug">Perioperative Documentation Standards (OT record completion) (IPP-OT-015)</span></li>
            ...
            <div class="policy-card bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden flex flex-col h-full">
                ...
                <div class="p-8 space-y-8 flex-grow">
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            <li class="flex items-start gap-3"><span class="font-bold text-cyan-600 shrink-0 w-10">12.1</span> <span class="leading-snug">Care &amp; Handling of Instruments and Equipment (IPP-OT-018)</span></li>
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-cyan-600 shrink-0 w-10">12.3</span> <span class="leading-snug">Electrosurgical Unit (Diathermy) Safety (IPP-OT-019)</span></li>
                            <li class="flex items-start gap-3"><span class="font-bold text-cyan-600 shrink-0 w-10">12.4</span> <span class="leading-snug">Warming Cabinet Use &amp; Safety (IPP-OT-020)</span></li>
                ...
                <div class="p-8 space-y-8 flex-grow">
                    <div>
                        ...
                        <ul class="space-y-3 text-[14px] text-slate-600 font-medium">
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-orange-600 shrink-0 w-10">13.2</span> <span class="leading-snug">Fire Safety in OT: Prevention &amp; Response (IPP-OT-023)</span></li>
                            ...
                            <li class="flex items-start gap-3"><span class="font-bold text-orange-600 shrink-0 w-10">13.8</span> <span class="leading-snug">Visitors to Operating Room (access, PPE, privacy, documentation) (IPP-OT-022)</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="policy-card bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl overflow-hidden border border-slate-200 flex flex-col mt-2">
                ...
                <div class="p-10">
                    <div class="grid grid-cols-1 gap-y-5">
                        ...
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f12" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-12</a> <span class="leading-snug mt-0.5">OT Cancellation Form + Reason Codes (linked to IPP-OT-024)</span></div>
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f13" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-13</a> <span class="leading-snug mt-0.5">OT On-Call Activation Log (linked to IPP-OT-021)</span></div>
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f14" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-14</a> <span class="leading-snug mt-0.5">OT→PACU Handover Checklist (linked to IPP-OT-017)</span></div>
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f15" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-15</a> <span class="leading-snug mt-0.5">Specimen Chain-of-Custody Log (linked to IPP-OT-014)</span></div>
                        ...
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f18" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-18</a> <span class="leading-snug mt-0.5">Diathermy Safety Checklist (linked to IPP-OT-019)</span></div>
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f19" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-19</a> <span class="leading-snug mt-0.5">Warming Cabinet Temperature Log (linked to IPP-OT-020)</span></div>
                        ...
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f22" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-22</a> <span class="leading-snug mt-0.5">Visitor Log (name, reason, PPE, consent/privacy acknowledgement) (linked to IPP-OT-022 &amp; Ethics policy)</span></div>
                        ...
                        <div class="flex items-start gap-4 text-[14px] text-slate-600 font-medium"><a href="/or-policies/form/f24" class="font-bold text-emerald-600 bg-emerald-50 hover:bg-emerald-100 px-2 py-0.5 rounded shrink-0 w-[80px] text-center transition-colors">F-OT-24</a> <span class="leading-snug mt-0.5">Fire Drill Evaluation Form (linked to IPP-OT-023)</span></div>
